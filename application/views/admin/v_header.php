...
<body>
    ...
    <button class="navbar-toggler" type="button" data-toggle="collapse" datatarget="#navbarText" aria-controls="navbarText" aria-expanded="false" arialabel="Toggle navigation">
    ...
    <div class="collapse navbar-collapse" id="navbarText">
        ...
        <li class="nav-item">
    <a class="nav-link" href="<?php echo base_url().'admin/anggota'; ?>"><i
    ...
    <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url().'admin/ganti_password' ?>" class="navlink"> <i class="fa fa-lock"></i> Ganti Password</a>
    </li>
</ul>
<span class="navbar-text mr-3 text-center">Halo, <?php echo $this->session->userdata('username'); ?> [admin]</span>
<a href="<?php echo base_url().'admin/logout' ?>" class="btn btn-outline-light m1-1"><i class="fa fa-power-off"></i> KELUAR</a>
</div>
</div>
</nav>
<br/>
