        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarText">
             <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url().'petugas/ganti_password' ?>" class="navlink"> <i class="fa fa-lock"></i> Ganti Password</a>
            </ul>
<span class="navbar-text mr-3 text-center">Halo, <?php echo $this->session->userdata('username'); ?> [Petugas]</span>
<a href="<?php echo base_url().'petugas/logout' ?>" class="btn btn-outline-light m1-1"><i class="fa fa-power-off"></i> KELUAR</a>
</div>
</div>
</nav>
<br/>
